...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"ts/storageHelper.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  StorageHelper.getState = function (item, valueSrc) {
    if (valueSrc === void 0) {
      valueSrc = '';
    }
  ...
  StorageHelper.setState = function (item, valueSrc) {
    if (valueSrc === void 0) {
      valueSrc = '';
    }
  ...
  StorageHelper.attach = function (item, valueSrc) {
    if (valueSrc === void 0) {
      valueSrc = '';
    }

    var eventType = valueSrc == 'innerText' ? 'input' : 'change';
...
/** @class */
function () {
  function Arc(selector, mh) {
    this.sh_ = storageHelper_1.StorageHelper;
    this.element_ = null;
    this.label_ = null;
    this.value_ = 0;
...
exports.Arc = Arc;
},{"./storageHelper":"ts/storageHelper.ts"}],"ts/midiHelper.ts":[function(require,module,exports) {
"use strict";
...
},{}],"ts/select.ts":[function(require,module,exports) {
"use strict";
...
function () {
  function Select(selector) {
    ...
    if (this.selector_) {
      this.element_ = document.querySelector(this.selector_);
      var state = this.sh_.getState(this.element_, 'selectedIndex');
  ...
  Select.prototype.attach_ = function () {
    if (this.element_) {
      this.element_.addEventListener('change', this.changeListener_.bind(this));
    }
  };

  Select.prototype.changeListener_ = function () {
    if (this.element_) {
...
},{"./storageHelper":"ts/storageHelper.ts"}],"index.ts":[function(require,module,exports) {
"use strict";
...
var midiHelper_1 = require("./ts/midiHelper");

var select_1 = require("./ts/select");
...
function () {
  function WebmidiController() {
    ...
    mh.connect(); // Instantiate selects.

    document.querySelectorAll('select.midi-select').forEach(function (select) {
      new select_1.Select("#" + select.id);
    }); // Instantiate sliders.

    document.querySelectorAll('input.arc').forEach(function (arc) {
  ...
  WebmidiController.prototype.saveState = function () {
    console.log('Saving state in localStorage'); // const saves = document.querySelectorAll('*[data-save]');
...
},{"./ts/arc":"ts/arc.ts","./ts/midiHelper":"ts/midiHelper.ts","./ts/select":"ts/select.ts"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
